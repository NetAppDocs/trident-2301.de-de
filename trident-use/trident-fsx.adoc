...
Amazon FSX für NetApp ONTAP nutzt https://docs.netapp.com/us-en/ontap/fabricpool/index.html["FabricPool"^] zum Management von Storage-Tiers. Diese ermöglicht die Speicherung von Daten in einer Tier, basierend darauf, ob häufig auf die Daten zugegriffen wird.
